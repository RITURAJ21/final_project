				...
				<center><div class="ex">
					<form action="CourseStudentServlet" method="post">
						<table style="width: 100%">
							<tr>
								<td>Course Id:</td>
								<td><input type="text" name="Course_Id" placeholder="eg.:L-100" pattern="[L]+-[1][0-9]{2}" required>
							...
							<tr>
								...
								<td><select name="Course_Duration" required>
							...
							<tr>
								...
								<td><input type="text" name="Course_Fees"
									placeholder="Enter the Course Fees" required/></td>
							</tr>
						...
						<center>
							<p>
								<a href="StreamStudent.jsp">STREAM ADD</a>
							</p>
						</center>
