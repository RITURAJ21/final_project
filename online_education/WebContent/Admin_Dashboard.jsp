...
.bgimg-1 {
  ...
  background-image: url("https://images.unsplash.com/photo-1530482817083-29ae4b92ff15?ixlib=rb-1.2.1&auto=format&fit=crop&w=1351&q=80");
  min-height: 100%;
}
.w3-bar .w3-button {
  padding: 16px;
  ...
  <div class="w3-bar w3-white w3-card" id="myNavbar">
   <img src="icon.JPG" alt="HTML5 Icon" style="width: 190px; height: 60px;"> 
    <div class="w3-right w3-hide-small">
      ...
      <a href="#" class="w3-bar-item w3-button"><i class="	fa fa-user"></i>Admin Profile </a>
...
<center></center><header class="bgimg-1 w3-display-container "  id="home">
...
<td><c:out value="${row.first_name}" /></td></tr>
<tr>
<td><b>Last Name</b></td>
<td><c:out value="${row.last_name}" /></td></tr>
<tr>
<td><b>Email</b></td>
<td><c:out value="${row.email}" /></td></tr>
<tr>
<td><b>Age</b></td>
<td><c:out value="${row.age}" /></td></tr>
<tr>
<td><b>Gender</b></td>
<td><c:out value="${row.gender}" /></td></tr>
<tr>
...
<footer class="w3-center w3-black w3-padding-40"> <%-- <div class="w3-xlarge w3-section">
