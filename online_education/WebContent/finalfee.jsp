...
button, input[type=text], input[type=email],input[type=Password],input[type=number], select
{
width: 100%;
padding: 12px 20px;
margin: 8px;
...
background-image:
url(https://images.unsplash.com/photo-1555762894-d8b5956368a1?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80);
...
<a href="front1.jsp" class="w3-bar-item w3-button"><i class="fa fa-home"></i>Home</a>
      ...
      <a href="#" class="w3-bar-item w3-button"><i class="fa fa-inr"></i>Fee Payment</a>
...
<div class="login h3">
<center><font color="white"><h3>If not Updated?<a href="fee1.jsp">Click here to Update!!</a></h3></font></center>
</center>
</div>
