...
<body>
	...
	<div class="row">
		...
		<center><div class="ex">
			<form action="StreamStudentServlet" method="post">
				<table style="width: 100%">
					...
					<tr>
						<td>Stream Name:</td>
						<td><select name="Stream_name" required>
  <option value="" disabled selected>Select an option...</option>
  <optgroup label="B.tech(L-101)">
    <option value="Computer Science">Computer Science</option>
    <option value="Information Technology">Information Technology</option>
    <option value="Mechanical">Mechanical</option>
  </optgroup>
  <optgroup label="B.Sc(L-102)">
    <option value="Physics">Physics</option>
    <option value="Chemistry">Chemistry</option>
    <option value="Math">Math</option>
  </optgroup>
  <optgroup label="B.Com(L-103)">
    <option value="Commerce">Commerce</option>
    <option value="law">law</option>
    <option value="Economics">Economics</option>
  </optgroup>
  <optgroup label="B.A(L-104)">
    <option value="Hindi">Hindi</option>
    <option value="English">English</option>
    <option value="Geography">Geography</option>
  </optgroup>
  <optgroup label="MBA(L-105)">
    <option value="Hindi">Human Resources</option>
    <option value="English">Executive</option>
    <option value="Geography">PGDM</option>
  </optgroup>
</select>
        </div>
						</select></td>
